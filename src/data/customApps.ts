...
if (!seedApps.some((app) => app.id === raveId)) {
  seedApps.push({
    ...
    description:
      'Смотрите фильмы, сериалы и видео вместе с друзьями в синхронном режиме.',
    iconText: 'R',
    iconGradient: 'linear-gradient(135deg,#7b2cff,#00d4ff)',
    rating: '4.7',
    reviews: '18K',
    rank: '#12 в Развлечения',
    tags: ['Фильмы', 'Видео', 'Watch Party'],
    screenshots: [
...
appStoreIcons[raveId] =
  'https://i.postimg.cc/kGPnwQyy/image.png';
