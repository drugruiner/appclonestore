...
await writeFile('public/rubox-final-v6.svg', svg, 'utf8');
await writeFile('public/apple-touch-icon.svg', svg, 'utf8');
await writeFile('public/apple-touch-icon-precomposed.svg', svg, 'utf8');
console.log('Generated RuBox final SVG icons v6 without native dependencies');
